    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item $p = 12$ quantitative variables
                \item 5 brands: Shein, Zara, H\&M, Forever 21, Uniqlo
                \item 10 countries, 2015-2024
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
...
\begin{frame}{Component Selection Criteria}
    ...
    \begin{enumerate}
        \item \textbf{Kaiser Criterion} (1960):
        \begin{equation*}
            \text{Retain PC}_k \text{ if } \lambda_k > 1
        \end{equation*}
        \textit{Rationale: Component should explain more than one original variable}
    ...
    \begin{columns}
        ...
        \begin{column}{0.42\textwidth}
            ...
            \begin{tabular}{ccc}
                ...
                4 & 1.05 & 35.5 \\
                5 & 1.03 & 44.1 \\
                \textcolor{secondary}{6} & \textcolor{secondary}{1.01} & \textcolor{secondary}{52.5} \\
                \midrule
                7 & 0.98 & 60.7 \\
                $\vdots$ & $\vdots$ & $\vdots$ \\
                \bottomrule
            ...
            \textcolor{primary}{\textbf{Kaiser: 6 components}}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Component Interpretation}
    \begin{block}{PC1 (9.20\% variance)}
        \textbf{Environmental Impact Dimension}
        \begin{itemize}
            \item High loadings: Carbon emissions, Water usage, Production volume
            \item Interpretation: Overall environmental footprint
        \end{itemize}
    \end{block}
    
    \vspace{0.3cm}
    
    \begin{block}{PC2 (8.83\% variance)}
        \textbf{Sustainability Governance Dimension}
        \begin{itemize}
            \item High loadings: Transparency index, Compliance score
            \item Interpretation: Corporate governance quality
        \end{itemize}
    \end{block}
    
    \vspace{0.3cm}
    
    \textbf{Total variance explained by PC1-PC2:} $18.03\%$
\end{frame}
...
\begin{frame}{Key Findings}
    \begin{enumerate}
        ...
        \begin{itemize}
            \item 12 variables $\rightarrow$ 6 components (Kaiser)
            \item 52.51\% variance retained
        \end{itemize}
        ...
        \begin{itemize}
            ...
            \item No major redundancy in environmental data
        \end{itemize}
        ...
        \begin{itemize}
            ...
            \item Fast fashion industry has homogeneous environmental profile
        \end{itemize}
    \end{enumerate}
\end{frame}
...
\begin{frame}{Methodological Summary}
    \begin{center}
        \begin{tikzpicture}[
            ...
            \node[box, left=of eig] (select) {Select $K$\\(Kaiser)};
...
\begin{frame}{Backup: Complete Eigenvalue Table}
    \begin{center}
        ...
        \begin{tabular}{ccccc}
            \toprule
            \textbf{PC} & $\boldsymbol{\lambda}$ & \textbf{Var.\%} & \textbf{Cum.\%} & \textbf{Kaiser} \\
            \midrule
            1 & 1.1041 & 9.20 & 9.20 & \checkmark \\
            2 & 1.0596 & 8.83 & 18.03 & \checkmark \\
            3 & 1.0549 & 8.79 & 26.81 & \checkmark \\
            4 & 1.0455 & 8.71 & 35.52 & \checkmark \\
            5 & 1.0335 & 8.61 & 44.13 & \checkmark \\
            6 & 1.0058 & 8.38 & 52.51 & \checkmark \\
            \midrule
            7 & 0.9833 & 8.19 & 60.70 & \\
            8 & 0.9762 & 8.13 & 68.84 & \\
            9 & 0.9655 & 8.04 & 76.88 & \\
            10 & 0.9465 & 7.88 & 84.76 & \\
            11 & 0.9299 & 7.75 & 92.51 & \\
            12 & 0.8991 & 7.49 & 100.00 & \\
            \bottomrule
        \end{tabular}
    \end{center}
\end{frame}
